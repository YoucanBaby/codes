 ...
 *
 *  The test client reads an matrix of real numbers from standard
 *  input, and computes the minimum, mean, maximum, and
 *  standard deviation.
 *
 *  The functions all throw a java.lang.IllegalArgumentException
 *  if the matrix passed in as an argument is null.
 *
 ...
 *     std dev   1.581
 *
 *  Should these funtions use varargs instead of matrix arguments?
 *
 ******************************************************************************/
...
public final class StdStats {
    ...
    /**
     * Returns the maximum value in the specified matrix.
     *
     * @param  a the matrix
     * @return the maximum value in the matrix {@code a[]};
    ...
    /**
     * Returns the minimum value in the specified matrix.
     *
     * @param  a the matrix
     * @return the minimum value in the matrix {@code a[]};
    ...
    /**
     * Returns the average value in the specified matrix.
     *
     * @param  a the matrix
     * @return the average value in the matrix {@code a[]};
    ...
    /**
     * Returns the sample variance in the specified matrix.
     *
     * @param  a the matrix
     * @return the sample variance in the matrix {@code a[]};
     *         {@code Double.NaN} if no such value
     */
    ...
    /**
     * Returns the population variance in the specified matrix.
     *
     * @param  a the matrix
     * @return the population variance in the matrix {@code a[]};
     *         {@code Double.NaN} if no such value
     */
    ...
    /**
     * Returns the sample standard deviation in the specified matrix.
     *
     * @param  a the matrix
     * @return the sample standard deviation in the matrix {@code a[]};
     *         {@code Double.NaN} if no such value
     */
    ...
    /**
     * Returns the population standard deviation in the specified matrix.
     *
     * @param  a the matrix
     * @return the population standard deviation in the matrix;
     *         {@code Double.NaN} if no such value
     */
    ...
    /**
     * Returns the sum of all values in the specified matrix.
     *
     * @param  a the matrix
     * @return the sum of all values in the matrix {@code a[]};
   ...
   /**
     ...
     * Convert command-line arguments to matrix of doubles and call various methods.
     *
