 ...
 *  matrix using an optimized binary insertion sort with half exchanges.
 *  <p>
 *  In the worst case, this implementation makes
 *  ~ <em>n</em> log<sub>2</sub><em>n</em> compares to sort an matrix of length
 *  <em>n</em>. However, in the worst case, the running time is
 *  &Theta;(<em>n</em><sup>2</sup>) because the number of matrix accesses
 *  can be quadratic.
...
public class BinaryInsertion {
    ...
    ***************************************************************************/
    ...
    // is the matrix sorted from a[lo] to a[hi]
