 ...
 * to the children and the whole matrix will be up to date.
 * <p>
 * Example:
 * <p>
...
public class SegmentTree {
     ...
     *
     * @param array the Initialization matrix
     */
    public SegmentTree(int[] array) {
        this.array = Arrays.copyOf(array, array.length);
        //The max size of this matrix is about 2 * 2 ^ log2(n) + 1
     ...
     * This behavior is really useful for updates on portions of the matrix
     * <p>
     * Time-Complexity: O(log(n))
     *
     * @param from  from index
    ...
    private void update(int v, int from, int to, int value) {
        ...
        //The Node of the heap tree represents a range of the matrix with bounds: [n.from, n.to]
        Node n = heap[v];
    ...
    //The Node class represents a partition range of the matrix.
    static class Node {
        int sum;
        int min;
     ...
     * init n v     Initializes the matrix of size n with all v's
     ...
     * up  a b v    Update the [a,b] portion of the matrix with value v.
     * exit
     * <p>
     * Example:
     * init
