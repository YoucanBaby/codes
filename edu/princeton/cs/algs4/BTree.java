 ...
 *   -  should b be an matrix of children or list (it would help with
 ...
 *  A symbol table implements the <em>associative matrix</em> abstraction:
...
public class BTree<Key extends Comparable<Key>, Value>  {
    ...
    private static final class Node {
        ...
        private Entry[] children = new Entry[M];   // the matrix of children
    ...
    private static class Entry {
        ...
        private Object val;
        private Node next;     // helper field to iterate over matrix entries
