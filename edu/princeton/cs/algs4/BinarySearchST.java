 ...
 *  
 *  Symbol table implementation with binary search in an ordered matrix.
 *
 *  % more tinyST.txt
 ...
 *  <p>
 *  This implementation uses a <em>sorted matrix</em>.
...
public class BinarySearchST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    // are the items in the matrix in ascending order?
