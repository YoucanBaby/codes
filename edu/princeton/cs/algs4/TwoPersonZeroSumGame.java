 ...
 *
 *  Solve an m-by-n two-Java基础.Person zero-sum game by reducing it to
 ...
 *  computing optimal row and column strategies to two-Java基础.Person zero-sum games.
 *  <p>
 *  This implementation solves an <em>m</em>-by-<em>n</em> two-Java基础.Person
 ...
 *  change solutions to the two-Java基础.Person zero-sum game.
 *  <p>
...
public class TwoPersonZeroSumGame {
    ...
    /**
     * Returns the optimal value of this two-Java基础.Person zero-sum game.
     *
     * @return the optimal value of this two-Java基础.Person zero-sum game
     *
     */
    public double value() {
    ...
    /**
     * Returns the optimal row strategy of this two-Java基础.Person zero-sum game.
     *
     * @return the optimal row strategy <em>x</em> of this two-Java基础.Person zero-sum game
     */
    public double[] row() {
        double scale = scale();
        double[] x = lp.primal();
    ...
    /**
     * Returns the optimal column strategy of this two-Java基础.Person zero-sum game.
     *
     * @return the optimal column strategy <em>y</em> of this two-Java基础.Person zero-sum game
     */
