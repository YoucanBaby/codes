 ...
 *  this by keeping the set of integers in a sorted matrix and using
...
public class StaticSETofInts {
    ...
    /**
     * Initializes a set of integers specified by the integer matrix.
     * @param keys the matrix of integers
    ...
    /**
     * Returns either the index of the search key in the sorted matrix
