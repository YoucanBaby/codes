...
public final class StdAudio {
    ...
    /**
     * Writes the matrix of samples (between -1.0 and +1.0) to standard audio.
     * If a sample is outside the range, it will be clipped.
     *
     * @param  samples the matrix of samples to play
    ...
    /**
     * Saves the double matrix as an audio file (using .wav or .au format).
     *
     * @param  filename the name of the audio file
