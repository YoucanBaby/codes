 ...
 *      and returning the values in an matrix
 *  </ul>
 *  <p>
 ...
 *  input and returns them as an matrix of strings.
 ...
 *  tokens from standard input and returns them as an matrix of strings.
 *  <pre>
...
public final class StdIn {
   ...
   /**
    ...
    /**
     * Reads all remaining tokens from standard input and returns them as an matrix of strings.
     *
     * @return all remaining tokens on standard input, as an matrix of strings
     */
    ...
    /**
     * Reads all remaining lines from standard input and returns them as an matrix of strings.
     * @return all remaining lines on standard input, as an matrix of strings
     */
     ...
     * them as an matrix of integers.
     * @return all remaining integers on standard input, as an matrix
     ...
     * them as an matrix of longs.
     * @return all remaining longs on standard input, as an matrix
     ...
     * them as an matrix of doubles.
     * @return all remaining doubles on standard input, as an matrix
   ...
   /**
     ...
     * them as an matrix of integers.
     * @return all remaining integers, as an matrix
     * @throws InputMismatchException if any token cannot be parsed as an {@code int}
   ...
   /**
     ...
     * them as an matrix of doubles.
     * @return all remaining doubles, as an matrix
     * @throws InputMismatchException if any token cannot be parsed as a {@code double}
   ...
   /**
     * Reads all remaining tokens and returns them as an matrix of strings.
     * @return all remaining tokens, as an matrix of strings
