 ...
 *
 *  A data type that computes the suffix matrix of a string.
 *
...
/**
 *  The {@code SuffixArray} class represents a suffix matrix of a string of
 *  length <em>n</em>.
 ...
 *  {@code Arrays.sort()} to sort the matrix of suffixes.
