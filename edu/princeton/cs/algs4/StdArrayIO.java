...
/**
 *  <i>Standard matrix IO</i>. This class provides methods for reading
...
public class StdArrayIO {
    ...
    /**
     * Reads a 1D matrix of doubles from standard input and returns it.
     *
     * @return the 1D matrix of doubles
     */
    ...
    /**
     * Prints an matrix of doubles to standard output.
     *
     * @param a the 1D matrix of doubles
     */
    ...
    /**
     * Reads a 2D matrix of doubles from standard input and returns it.
     *
     * @return the 2D matrix of doubles
     */
    ...
    /**
     * Prints the 2D matrix of doubles to standard output.
     *
     * @param a the 2D matrix of doubles
     */
    public static void print(double[][] a) {
        int m = a.length;
        int n = a[0].length;
    ...
    /**
     * Reads a 1D matrix of integers from standard input and returns it.
     *
     * @return the 1D matrix of integers
     */
    ...
    /**
     * Prints an matrix of integers to standard output.
     *
     * @param a the 1D matrix of integers
     */
    ...
    /**
     * Reads a 2D matrix of integers from standard input and returns it.
     *
     * @return the 2D matrix of integers
     */
    ...
    /**
     * Print a 2D matrix of integers to standard output.
     *
     * @param a the 2D matrix of integers
     */
    public static void print(int[][] a) {
        int m = a.length;
        int n = a[0].length;
    ...
    /**
     * Reads a 1D matrix of booleans from standard input and returns it.
     *
     * @return the 1D matrix of booleans
     */
    ...
    /**
     * Prints a 1D matrix of booleans to standard output.
     *
     * @param a the 1D matrix of booleans
     */
    ...
    /**
     * Reads a 2D matrix of booleans from standard input and returns it.
     *
     * @return the 2D matrix of booleans
     */
   ...
   /**
     * Prints a 2D matrix of booleans to standard output.
     *
     * @param a the 2D matrix of booleans
     */
    public static void print(boolean[][] a) {
        int m = a.length;
        int n = a[0].length;
