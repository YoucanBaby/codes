...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     *
     * @param  x an matrix of all the <em>x</em>-coordinates of the polygon
     * @param  y an matrix of all the <em>y</em>-coordinates of the polygon
    ...
    public void polygon(double[] x, double[] y) {
        validateNotNull(x, "x-coordinate matrix");
        validateNotNull(y, "y-coordinate matrix");
