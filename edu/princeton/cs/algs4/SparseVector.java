...
public class SparseVector {
   ...
   /**
    ...
    /**
     * Returns the inner product of this vector with the specified matrix.
     *
     * @param  that the matrix
     * @return the dot product between this vector and that matrix
     * @throws IllegalArgumentException if the dimensions of the vector and the matrix are not equal
     */
