 ...
 *  matrix using an optimized version of mergesort.
 *  <p>
 *  In the worst case, this implementation takes
 *  &Theta;(<em>n</em> log <em>n</em>) time to sort an matrix of
...
public class MergeX {
    ...
    /**
     * Rearranges the matrix in ascending order, using the provided order.
     *
     * @param a the matrix to be sorted
