 ...
 *  Q X P (6 left on pq)
 *
 *  We use a one-based matrix to simplify parent and child calculations.
 *
 ...
 *  (and not a worst-case bound) because of matrix resizing operations.
...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    /**
     * Initializes a priority queue from the matrix of keys.
    ...
    // resize the underlying matrix to have the given capacity
    ...
    public void insert(Key x) {
        ...
        // double size of matrix if necessary
