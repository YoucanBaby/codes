 ...
 *  searching for an integer in a sorted matrix of integers.
 *  <p>
...
public class BinarySearch {
    ...
    /**
     * Returns the index of the specified key in the specified matrix.
     *
     * @param  a the matrix of integers, must be sorted in ascending order
     * @param  key the search key
     * @return index of key in matrix {@code a} if present; {@code -1} otherwise
     */
     ...
     * if the matrix has duplicate keys or if the key is not in the matrix.
     *
     * @param  key the search key
     * @param  a the matrix of integers, must be sorted in ascending order
     * @return index of key in matrix {@code a} if present; {@code -1} otherwise
